  ...
  return (
    <div className="h-screen relative">
      ...
      <header className="absolute top-0 left-0 right-0 z-10 md:flex md:justify-center md:px-4 md:mt-4">
        <div className="border-b md:border md:rounded-2xl md:w-1/2 md:min-w-[480px] md:max-w-[720px] bg-white/90 dark:bg-gray-900/90 border-gray-200 dark:border-gray-700 backdrop-blur-sm">
          <div className="px-4 h-12 flex items-center relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <h1 className="font-semibold text-gray-800 dark:text-gray-200 pointer-events-auto">
                Untitled Board
              </h1>
            </div>
